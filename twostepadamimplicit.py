import math
def twostepadamimiplicit(a,b,y_a,h):
    """The function return ths value of y at b using two step Adam Bashforth Explicit Method"""
    w_0=y_a
    t=a
    #compute first step using Runge Kutta Method of order 3
    w_1=RK3(a,a+h,y_a,h/5)#error has to be of same order since implicit has local truncation errror 3
    while t<b-h:
...
def error(a,b,y_a,h):
    ...
    print(actual)
    return abs(actual-twostepadamimiplicit(a,b,y_a,h))
a=0
b=1
y_a=0
h=0.2
